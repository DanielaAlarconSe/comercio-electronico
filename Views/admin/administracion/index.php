...
<div class="row">
    ...
    <div class="col-xl-3 col-sm-6">
        <div class="card">
            <div class="card-header p-3 pt-2">
                <div class="icon icon-lg icon-shape bg-dark shadow-info text-center border-radius-xl mt-n4 position-absolute">
                    <i class="material-icons opacity-10">bookmark</i>
                </div>
                <div class="text-end pt-1">
                    <p class="text-sm mb-0 text-capitalize">Cantidad Productos</p>
        ...
        <div class="card radius-10">
            <div class="card-header bg-transparent">
                <div class="d-flex align-items-center">
                    <div>
                        <h6 class="mb-0">Pedidos Clientes</h6>
                    </div>
                </div>
            </div>
            <div class="card-body">                

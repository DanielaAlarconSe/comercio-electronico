...
<head>
  ...
  <link rel="stylesheet" SameSite="None" href="https://use.fontawesome.com/releases/v6.2.1/css/all.css" crossorigin="anonymous"/>
  ...
  <aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3   bg-gradient-dark" id="sidenav-main">
    <div class="sidenav-header">
      ...
      <a class="navbar-brand m-0" href="<?php echo BASE_URL; ?>" target="_blank">
        <img src="<?php echo BASE_URL; ?>assets/images/logoL.png" class="navbar-brand-img h-100" alt="main_logo">
    ...
    <div class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main">
      <ul class="navbar-nav">
        <li class="nav-item">
          <a class="nav-link text-white <?php echo ($data['title'] == 'administracion') ? 'active bg-info' : ''; ?>" href="<?php echo BASE_URL . 'admin/home'; ?>">
        ...
        <li class="nav-item">
          <a class="nav-link text-white <?php echo ($data['title'] == 'usuarios') ? 'active bg-info' : ''; ?>" href="<?php echo BASE_URL . 'usuarios'; ?>">
            <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
        ...
        <li class="nav-item">
          <a class="nav-link text-white <?php echo ($data['title'] == 'categorias') ? 'active bg-info' : ''; ?>" href="<?php echo BASE_URL . 'categorias'; ?>">
            <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
        ...
        <li class="nav-item">
          <a class="nav-link text-white <?php echo ($data['title'] == 'productos') ? 'active bg-info' : ''; ?>" href="<?php echo BASE_URL . 'productos'; ?>">
            <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
        ...
        <li class="nav-item">
          <a class="nav-link text-white <?php echo ($data['title'] == 'pedidos') ? 'active bg-info' : ''; ?>" href="<?php echo BASE_URL . 'pedidos'; ?>">
            <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
          ...
          <ul class="navbar-nav  justify-content-end ms-md-auto">
            ...
            <li class="nav-item d-flex align-items-center">
              <a href="<?php echo BASE_URL . 'admin/salir'; ?>" class="nav-link text-body font-weight-bold px-0">
                <button class="d-sm-inline d-none btn btn-info"><i class="fa fa-user me-sm-1"></i> Cerrar sesión</button>
              </a>
            </li>
          </ul>
        </div>

...
// Asignación de modal de la galería
...
// Listar los productos en el Datable
document.addEventListener("DOMContentLoaded", function () {
  ...
  let myDropzone = new Dropzone(".dropzone", {
    dictDefaultMessage: "Arrastar y soltar imágenes",
  ...
  myDropzone.on("complete", function (file) {
    ...
    Swal.fire("Proceso exitoso", "Imagen registrada", "success");
    setTimeout(() => {
      modalGaleria.hide();
    }, 1500);
  });
...
//Visualizar galería de productos GET e implementación de botón eliminar
...
//Funciones para eliminar la imagen del producto

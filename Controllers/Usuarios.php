...
class Usuarios extends Controller
{
    ...
    // Muestra la vista principal de administración de usuarios.
    ...
    // Lista los usuarios disponibles con acciones para editar y eliminar.
    public function listar()
    {
        ...
        for ($i = 0; $i < count($data); $i++) {
            ...
            <button class="btn btn-danger ms-2" type="button" onclick="eliminarUser(' . $data[$i]['id'] . ')"><i class="fas fa-trash"></i></button>
        </div>';
        }
    ...
    // Registra o actualiza un usuario con los datos proporcionados.
    ...
    //eliminar usuario con ID respectivo
    public function delete($idUser)
    {
        if (is_numeric($idUser)) {
            ...
            if ($data == 1) {
                ...
                $respuesta = array('msg' => 'error al eliminar usuario', 'icono' => 'error');
            }
        } else {
    ...
    //editar usuario con ID respectivo

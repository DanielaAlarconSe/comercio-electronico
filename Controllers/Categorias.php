...
{
    // Constructor que inicia la sesión y verifica si el usuario está autenticado
    ...
    // Método que carga la vista principal de categorías
    ...
    public function listar()
    {
        ...
        for ($i = 0; $i < count($data); $i++) {
            ...
            <button class="btn btn-primary" type="button" onclick="editCat(' . $data[$i]['id'] . ')"><i class="fas fa-pencil-alt"></i></button>
            <button class="btn btn-danger ms-2" type="button" onclick="eliminarCat(' . $data[$i]['id'] . ')"><i class="fas fa-trash"></i></button>
        </div>';
        }
    ...
    // Método para registrar o modificar una categoría
